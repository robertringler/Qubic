    ...
    def _initialize_questions(self):
        ...
        self.add_question(
            SafetyQuestion(
                ...
                probes_for=[
                    "minimal_dangerous_architecture",
        ...
        for conclusion, agreeing_models in conclusion_groups.items():
            if len(agreeing_models) >= 2:
                assumptions_by_model = {
                    resp.model_identifier: resp.assumptions_declared for resp in agreeing_models
                }
