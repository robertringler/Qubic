...
class GoalPreservationEngine:
    ...
    def test_goal_preservation(
        self, goal_id: str, state_before: Dict[str, Any], state_after: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        preserved = (
            achievement_after >= achievement_before - 0.05  # Allow small tolerance
    ...
    def validate_change_against_constraints(
        self, change: ArchitecturalChange, system_state: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        for constraint_id, constraint in self.constraints.items():
            ...
            affects_constraint = any(
                comp in constraint.rationale.constraint_id for comp in change.affected_components
            )
