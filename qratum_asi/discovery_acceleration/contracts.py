...
class DiscoveryContract:
    ...
    def add_intent(self, intent: CrossVerticalIntent) -> None:
        ...
        self.merkle_chain.add_event("intent_added", {
    ...
    def add_hypothesis(
        ...
        self.merkle_chain.add_event("hypothesis_generated", {
            "hypothesis_id": hypothesis_id,
            "confidence": confidence,
            "domains": domains,
        })
    ...
    def authorize(
        ...
        self.merkle_chain.add_event("authorization_added", {
            "authorizer_id": authorizer_id,
            "authorization_type": authorization_type,
        })
    ...
    def _check_authorization_status(self) -> None:
        ...
        if all_authorized and self.status == ContractStatus.SUBMITTED:
            ...
            self.merkle_chain.add_event("contract_authorized", {
                "contract_id": self.contract_id,
            })
    ...
    def submit(self) -> bool:
        ...
        self.merkle_chain.add_event("contract_submitted", {
            "contract_id": self.contract_id,
    ...
    def execute(self) -> dict[str, Any]:
        ...
        if results["success"]:
            ...
            self.merkle_chain.add_event("contract_completed", {
                "contract_id": self.contract_id,
                "intents_completed": len(results["intents_executed"]),
            })
        else:
            self.status = ContractStatus.FAILED
            self.merkle_chain.add_event("contract_failed", {
                "contract_id": self.contract_id,
            })
...
def create_discovery_contract(
    ...
    """
    contract_id = f"dc_{discovery_type.value}_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}"
