...
Production-ready infrastructure and application stack for the QuASIM **Energy Grid** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising energy grid insights returned by the kernels.
...
POSIX: `docker build -t quasim/energy_grid:backend services/backend`

Windows: `docker build -t quasim/energy_grid:backend services\backend`
