...
185	      	[ ] invalid-syntax
 ...
 12	SIM108	[ ] if-else-block-instead-of-if-exp
...
Found 2052 errors.
[*] 10 fixable with the `--fix` option (1297 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
