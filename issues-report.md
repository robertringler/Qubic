...
185	      	[ ] invalid-syntax
 ...
 33	B007  	[ ] unused-loop-control-variable
...
Found 2299 errors.
[*] 233 fixable with the `--fix` option (1356 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
