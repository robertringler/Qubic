...
Found 2161 errors.
[*] 10 fixable with the `--fix` option (1324 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
