...
### Ruff Linting
1328	W293  	[ ] blank-line-with-whitespace
 ...
 192	UP006 	[ ] non-pep585-annotation
  ...
  15	C401  	[ ] unnecessary-generator-set
  ...
  10	SIM118	[ ] in-dict-keys
   ...
   5	N818  	[ ] error-suffix-on-exception-name
...
Found 2709 errors.
[*] 10 fixable with the `--fix` option (1935 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
