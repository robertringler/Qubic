...
Found 2586 errors.
[*] 265 fixable with the `--fix` option (1597 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
