...
1319	      	[ ] invalid-syntax
 ...
 290	N806  	[ ] non-lowercase-variable-in-function
 198	UP045 	[ ] non-pep604-annotation-optional
 192	UP006 	[ ] non-pep585-annotation
 125	F821  	[ ] undefined-name
 119	F841  	[ ] unused-variable
  76	E402  	[ ] module-import-not-at-top-of-file
  62	B007  	[ ] unused-loop-control-variable
  56	N803  	[ ] invalid-argument-name
  56	SIM102	[ ] collapsible-if
...
Found 3720 errors.
[*] 10 fixable with the `--fix` option (1390 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
