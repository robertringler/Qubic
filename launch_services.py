...
backend_cmd = [VENV_PY, os.path.join(ROOT, 'all_analyses.py'), '--Lx', '8', '--Ly', '8', '--disorder', '0.2', '--T', '5', '--dt', '0.02']
frontend_cmd = [VENV_PY, '-m', 'streamlit', 'run', os.path.join(ROOT, 'quantum_simulator_dashboard', 'app.py'), '--server.headless', 'true']
