...
Production-ready infrastructure and application stack for the QuASIM **Healthcare Analytics** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising healthcare analytics insights returned by the kernels.
...
POSIX: `docker build -t quasim/healthcare_analytics:backend services/backend`

Windows: `docker build -t quasim/healthcare_analytics:backend services\backend`
