...
class PatentInventionExtractor:
    ...
    def extract_all_inventions(self):
        ...
        self.inventions.append(PatentInvention(
            id="PATENT-001",
            ...
            keywords=[
                "reinforcement learning", "kernel optimization", "autonomous systems",
                "formal verification", "energy efficiency", "federated learning"
            ],
            priority="High",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "hybrid architecture", "NVLink-C2C", "quantum-classical", "zero-copy",
                "GPU acceleration", "coherent fabric"
            ],
            priority="High",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "precision management", "mixed precision", "error budgeting",
                "numerical accuracy", "quantum simulation"
            ],
            priority="Medium",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "compiler optimization", "gradient descent", "scheduling",
                "performance optimization", "differentiable programming"
            ],
            priority="Medium",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "Ising model", "simulated annealing", "quantum-inspired optimization",
                "configuration search", "kernel tuning"
            ],
            priority="Medium",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "memory optimization", "graph neural networks", "cache optimization",
                "tensor layout", "memory hierarchy"
            ],
            priority="Medium",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "causal profiling", "performance analysis", "perturbation experiments",
                "counterfactual analysis", "profiling"
            ],
            priority="Low",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "continuous certification", "DO-178C", "compliance automation",
                "CI/CD", "quantum software", "aerospace"
            ],
            priority="High",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "market analysis", "enterprise readiness", "quantum adoption",
                "business intelligence", "scoring system"
            ],
            priority="Low",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "aerospace simulation", "digital twins", "mission validation",
                "spacecraft", "quantum optimization"
            ],
            priority="High",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "distributed computing", "GPU scaling", "quantum simulation",
                "fault tolerance", "MPI", "NCCL"
            ],
            priority="High",
        ...
        self.inventions.append(PatentInvention(
            ...
            keywords=[
                "digital twins", "CFT", "quantum enhancement", "ONNX",
    ...
    def generate_markdown_report(self, output_file: str = "PATENT_INVENTIONS.md"):
        ...
        md_lines = [
            ...
            f"**Project:** QuASIM (Quantum-Accelerated Simulation Infrastructure)",
            "",
            "---",
            "",
            "## Executive Summary",
        ...
        for pri, count in sorted(priorities.items(), key=lambda x: ["High", "Medium", "Low"].index(x[0])):
        ...
        sorted_inventions = sorted(self.inventions, key=lambda x: (priority_order[x.priority], x.id))
