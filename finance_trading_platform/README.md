...
Production-ready infrastructure and application stack for the QuASIM **Finance Trading** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising finance trading insights returned by the kernels.
...
POSIX: `docker build -t quasim/finance_trading:backend services/backend`

Windows: `docker build -t quasim/finance_trading:backend services\backend`
