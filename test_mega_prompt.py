...
def test_question_set():
    ...
    print(f"  ✓ Question IDs Q1-Q20 present")
...
def test_mandatory_rules():
    ...
    print(f"  ✓ Rule 1 (benevolence) violation detected")
    ...
    print(f"  ✓ Rule 2 (mechanisms over morals) violation detected")
    ...
    print(f"  ✓ Valid response passes validation")
...
def test_orchestration():
    ...
    print(f"  ✓ 3 model adapters registered")
    ...
    print(f"  ✓ Single question interrogation works")
    ...
    print(f"  ✓ Responses recorded in system")
...
def test_prompt_generation():
    ...
    print(f"  ✓ Single question prompt generated correctly")
    ...
    print(f"  ✓ Full document generated correctly")
