...
Generated: 2026-01-03T03:19:32.558776
...
| Model | Primary Metric | Secondary Metric | Latency (ms) | Stability | Deterministic |
|-------|---------------|------------------|--------------|-----------|---------------|
| slt | 0.9910 ± 0.0020 | 0.9910 ± 0.0020 | 15.26 | 0.998 | ❌ |
...
|------|------|-------|---------------------|
| 1 | tabular-cls | logreg | 99.073318 |
| 2 | tabular-cls | mlp | 78.057563 |
| 3 | tabular-cls | rf | 2.689835 |
| 4 | tabular-cls | slt | 1.608502 |
| 5 | text-cls | slt | 0.997384 |
