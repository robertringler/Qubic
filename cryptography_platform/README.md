...
Production-ready infrastructure and application stack for the QuASIM **Cryptography** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising cryptography insights returned by the kernels.
...
POSIX: `docker build -t quasim/cryptography:backend services/backend`

Windows: `docker build -t quasim/cryptography:backend services\backend`
