# Optimization Services Platform

Production-ready infrastructure and application stack for the QuASIM **Optimization Services** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising optimization services insights returned by the kernels.
...
POSIX: `docker build -t quasim/optimization_services:backend services/backend`

Windows: `docker build -t quasim/optimization_services:backend services\backend`
