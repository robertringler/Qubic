# Quantum Benchmarks Platform

Production-ready infrastructure and application stack for the QuASIM **Quantum Benchmarks** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising quantum benchmarks insights returned by the kernels.
...
POSIX: `docker build -t quasim/quantum_benchmarks:backend services/backend`

Windows: `docker build -t quasim/quantum_benchmarks:backend services\backend`
