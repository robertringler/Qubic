...
class TireDataAdapter:
    ...
    This adapter converts QuASIM tire simulation results into formats
    ...
    def extract_visualization_data(simulation_result: Any) -> dict[str, Any]:
        ...
        return {
            ...
            "load_kg": simulation_result.load_kg,
            "pressure_kpa": simulation_result.pressure_kpa,
            "speed_kmh": simulation_result.speed_kmh,
    ...
    def _extract_thermal_map(simulation_result: Any) -> np.ndarray:
        ...
        temp_ambient = simulation_result.environment.temperature_celsius
    ...
    def _extract_wear_pattern(simulation_result: Any) -> np.ndarray:
        ...
        wear_rate = simulation_result.performance_metrics.wear_rate
