# Telecom Networks Platform

Production-ready infrastructure and application stack for the QuASIM **Telecom Networks** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising telecom networks insights returned by the kernels.
...
POSIX: `docker build -t quasim/telecom_networks:backend services/backend`

Windows: `docker build -t quasim/telecom_networks:backend services\backend`
