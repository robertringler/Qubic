...
class TestBitBoard:
    ...
    def test_attack_map(self):
        ...
        from qratum_chess.core import BitBoard, Color
...
class TestPosition:
    ...
    def test_starting_position(self):
        ...
        from qratum_chess.core import CastlingRights, Color
...
class TestSearch:
    ...
    def test_mcts_basic(self):
        ...
        best_move, visit_counts, value = mcts.search(pos, num_simulations=100)
