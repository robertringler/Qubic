...
class TestKaggleCompetitionConfig:
    ...
    def test_custom_config(self):
        ...
        config = KaggleCompetitionConfig(
            competition_id="test-competition", submission_format="json"
        )
...
class TestKaggleBenchmarkPosition:
    ...
    def test_invalid_fen(self):
        ...
        pos = KaggleBenchmarkPosition(position_id="invalid", fen="invalid_fen_string")
...
class TestKaggleIntegration:
    ...
    def test_load_from_file(self):
        ...
        test_data = {
            ...
            "leaderboard": [{"team": "TestTeam", "score": 0.95}],
        }
...
class TestSubmissionResult:
    ...
    def test_failed_result(self):
        ...
        result = SubmissionResult(success=False, error="Test error")
...
class TestKaggleLeaderboardData:
    ...
    def test_get_position_by_id(self):
        ...
        pos1 = KaggleBenchmarkPosition(
            position_id="pos_1", fen="rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
        )
        pos2 = KaggleBenchmarkPosition(
            position_id="pos_2", fen="rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1"
        )

        leaderboard = KaggleLeaderboardData(
            positions=[pos1, pos2], leaderboard_entries=[], metadata={}
        )
    ...
    def test_get_top_engines(self):
        ...
        leaderboard = KaggleLeaderboardData(positions=[], leaderboard_entries=entries, metadata={})
