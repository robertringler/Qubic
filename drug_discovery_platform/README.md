...
Production-ready infrastructure and application stack for the QuASIM **Drug Discovery** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising drug discovery insights returned by the kernels.
...
POSIX: `docker build -t quasim/drug_discovery:backend services/backend`

Windows: `docker build -t quasim/drug_discovery:backend services\backend`
