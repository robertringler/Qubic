...
Production-ready infrastructure and application stack for the QuASIM **Material Science** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising material science insights returned by the kernels.
...
POSIX: `docker build -t quasim/material_science:backend services/backend`

Windows: `docker build -t quasim/material_science:backend services\backend`
