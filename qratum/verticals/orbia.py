...
class OrbiaModule(VerticalModuleBase):
    ...
    def execute_task(self, task: str, parameters: Dict[str, Any],
        ...
        handlers = {
            ...
            "optimize_constellation": lambda p: {"num_satellites": p.get("satellites", 24),
                                                "orbital_planes": 6, "coverage": 0.98,
                                                "revisit_time_min": 15},
            "avoid_collision": lambda p: {"collision_probability": 0.0001, "miss_distance_m": 250,
                                         "maneuver_required": False, "time_to_ca_hours": 6},
            "analyze_link_budget": lambda p: {"link_margin_db": 12, "data_rate_mbps": 150,
                                             "availability": 0.995, "antenna_size_m": 2.5},
            "plan_mission": lambda p: {"mission_type": p.get("type", "earth_observation"),
                                      "duration_days": 365, "delta_v_budget_ms": 150,
                                      "power_budget_w": 2000},
