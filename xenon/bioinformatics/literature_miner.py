...
class LiteratureMiner:
    ...
    def extract_mechanism_keywords(self, publication: Publication) -> List[str]:
        ...
        mechanism_keywords = [
            'phosphorylation', 'activation', 'inhibition', 'binding',
            'catalysis', 'signaling', 'pathway', 'regulation',
            'conformational change', 'allosteric', 'enzyme',
            'substrate', 'product', 'kinase', 'phosphatase',
        ]
