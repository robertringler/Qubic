...
class DrugTargetScorer:
    ...
    def compute_drug_likeness(self, drug_id: str) -> Dict[str, any]:
        ...
        subscores = [
            ...
            if isinstance(v, float) and not k.startswith("is_")
        ]
    ...
    def assess_target_druggability(
        ...
        scores["tractability_score"] = (
            scores["binding_site_score"] * 0.6 +
            scores["ligandability_score"] * 0.4
        )
    ...
    def compute_selectivity(
        ...
        off_target_affinities = [
            self.compute_binding_affinity_score(drug_id, ot)
