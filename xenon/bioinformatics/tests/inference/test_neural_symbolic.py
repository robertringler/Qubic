...
class TestNeuralSymbolicEngine:
    ...
    def test_deterministic_inference(self):
        ...
        np.testing.assert_array_almost_equal(result1.predictions, result2.predictions, decimal=6)
        np.testing.assert_array_almost_equal(
            result1.embeddings.node_embeddings, result2.embeddings.node_embeddings, decimal=6
        )
    ...
    def test_different_graph_sizes(self):
        ...
        edge_index_large = np.array([list(range(99)), list(range(1, 100))])
    ...
    def test_output_shapes(self):
        ...
        engine = NeuralSymbolicEngine(
            input_dim=input_dim, hidden_dim=hidden_dim, output_dim=output_dim, seed=42
        )
