...
class ByzantineSimulator:
    ...
    def _attack_double_voting(self) -> AdversarialResult:
        ...
        return AdversarialResult(
            ...
            recommendations=[
                (
                    "Implement double-vote detection and slashing"
                    if attack_succeeded
    ...
    def _attack_proposal_withholding(self) -> AdversarialResult:
        ...
        return AdversarialResult(
            ...
            recommendations=[
                (
                    "Reduce timeout for view changes"
                    if attack_succeeded
    ...
    def _attack_vote_manipulation(self) -> AdversarialResult:
        ...
        for _ in range(rounds):
            ...
            if (true_count > self.num_validators // 2) != (
                reported_count > self.num_validators // 2
            ):
        ...
        return AdversarialResult(
            ...
            recommendations=[
                "Verify all vote signatures" if attack_succeeded else "Vote verification adequate",
            ],
        )
    ...
    def _attack_collusion_safety(self) -> AdversarialResult:
        ...
        return AdversarialResult(
            ...
            recommendations=[
                (
                    f"Reduce Byzantine tolerance to <{safety_threshold:.0f}"
                    if attack_succeeded
...
class TimingAnalyzer:
    ...
    def measure(self, inputs: list[Any]) -> AdversarialResult:
        ...
        return AdversarialResult(
            ...
            recommendations=[
                (
                    "Review operation for data-dependent branches"
                    if timing_leak_detected
...
class EntropyStarvationTest:
    ...
    def test_degraded_entropy(
        ...
        attack_succeeded = results.get("zero_entropy", {}).get("success", False) or results.get(
            "low_entropy", {}
        ).get("success", False)
...
class CensorshipProber:
    ...
    def run_probe_test(
        ...
        return AdversarialResult(
            ...
            recommendations=[
                (
                    "Investigate blocked probes for censorship"
