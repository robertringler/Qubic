...
from services.rag import RAGConnector, batch_embed, embed_text, retrieve
...
def test_rag_index_documents():
    ...
    # Valid documents
    docs = [{"id": "doc1", "text": "First document"}, {"id": "doc2", "text": "Second document"}]
...
def test_rag_integration():
    ...
    docs = [{"id": f"doc{i}", "text": f"Document {i} content"} for i in range(10)]
