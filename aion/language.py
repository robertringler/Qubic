...
class AIONParser:
    ...
    def _parse_region(self) -> AIONASTNode:
        ...
        hardware = "CPU"
        if self._current().kind in (TokenKind.GPU, TokenKind.GPU_STREAM0, TokenKind.GPU_STREAM1,
                                     TokenKind.FPGA, TokenKind.FPGA_LUT, TokenKind.CPU) or self._current().kind == TokenKind.IDENTIFIER:
    ...
    def _parse_comparison(self) -> AIONASTNode:
        ...
        while self._current().kind in (TokenKind.EQ, TokenKind.NE, TokenKind.LT,
