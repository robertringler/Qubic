% Cleaned RevTeX 4.2 source for PRX-style submission
...
% If physics and siunitx both define \qty, prefer siunitx's definition.
% We load siunitx after physics so it will provide \qty; avoid fragile redefinitions here.
...
% (body of manuscript continues... preserved from original arXiv source)
...
% If physics and siunitx both define \qty, prefer siunitx's definition (siunitx is loaded after physics here)
% No shim needed because siunitx is loaded after physics and will define \qty; avoid fragile redefinitions.
...
\begin{subfigure}{0.48\columnwidth}
	...
	\caption{Entropy scaling from a 1D long-range free-fermion model (simulation performed using correlation-matrix methods).}
\end{subfigure}
