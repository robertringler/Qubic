...
Production-ready infrastructure and application stack for the QuASIM **Supply Chain** vertical. The solution targets AWS by default with guidance for Azure and GCP consumers.
...
* **Frontend**: Lightweight dashboard visualising supply chain insights returned by the kernels.
...
POSIX: `docker build -t quasim/supply_chain:backend services/backend`

Windows: `docker build -t quasim/supply_chain:backend services\backend`
