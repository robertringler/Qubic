...
class PerformanceMetrics:
    ...
    def measure_nodes_per_second(
        self, engine, position, duration_seconds: float = 1.0, num_threads: int = 1
    ) -> PerformanceResult:
        ...
        target = (
            self.targets.nodes_per_sec_single
            if num_threads == 1
    ...
    def measure_mcts_rollouts(
        self, mcts_engine, position, duration_seconds: float = 1.0
    ) -> PerformanceResult:
    ...
    def measure_nn_eval_latency(
        self, evaluator, positions: list, num_samples: int = 1000
    ) -> PerformanceResult:
    ...
    def measure_hash_hit_rate(self, engine, positions: list, depth: int = 8) -> PerformanceResult:
    ...
    def run_full_benchmark(self, engine, evaluator, positions: list) -> PerformanceReport:
