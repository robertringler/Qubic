...
class ResilienceTestResult:
    ...
    def passed(self) -> bool:
        ...
        return (
            self.recovered_successfully and
            not self.illegal_move_generated and
...
class ResilienceReport:
    ...
    def finalize(self) -> None:
        ...
        self.average_recovery_ms = sum(recovery_times) / len(recovery_times) if recovery_times else 0
