...
class TortureSuiteReport:
    ...
    def passed(self) -> bool:
        ...
        return (
            self.eval_volatility <= 0.05
            and self.blunder_rate <= 0.0001
            and self.tablebase_errors == 0
        )
...
class StrategicTortureSuite:
    ...
    TRAPPED_PIECE_POSITIONS = [
        ...
        (
            "trapped_bishop",
            "r1bqk2r/pppnbppp/3p1n2/4p3/4P3/3P1N2/PPPNBPPP/R1BQK2R w KQkq - 4 6",
            None,
        ),
        (
            "trapped_knight",
    ...
    def run_single_category(self, engine, category: str, depth: int = 15) -> TortureSuiteReport:
