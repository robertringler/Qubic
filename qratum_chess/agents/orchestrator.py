...
class MetaStrategyDirector(BaseAgent):
    ...
    def _full_analysis(self, position: 'Position') -> dict[str, Any]:
        ...
        total_material = sum(
            ...
            for c in Color for pt in PieceType
        )
...
class AgentOrchestrator:
    ...
    def get_best_move(
        ...
        pos_response = self.route_message(AgentMessage(
            msg_type=MessageType.REQUEST,
            sender="orchestrator",
            receiver="board_manager",
            action="get_position",
        ...
        strategy_response = self.route_message(AgentMessage(
            msg_type=MessageType.REQUEST,
            sender="orchestrator",
            receiver="director",
        ...
        search_response = self.route_message(AgentMessage(
            msg_type=MessageType.REQUEST,
            sender="orchestrator",
        ...
        if search_result.get("best_move"):
            validation_response = self.route_message(AgentMessage(
                msg_type=MessageType.REQUEST,
                sender="orchestrator",
                receiver="validator",
        ...
        # Get evaluation
        eval_response = self.route_message(AgentMessage(
            msg_type=MessageType.REQUEST,
            sender="orchestrator",
            receiver="evaluator",
    ...
    def new_game(self, fen: str | None = None) -> dict[str, Any]:
        ...
        """
        response = self.route_message(AgentMessage(
            msg_type=MessageType.REQUEST,
            sender="orchestrator",
            receiver="board_manager",
            action="set_position",
    ...
    def get_analysis(self) -> dict[str, Any]:
        ...
        analysis_response = self.route_message(AgentMessage(
            msg_type=MessageType.REQUEST,
            sender="orchestrator",
            receiver="director",
