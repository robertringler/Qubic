...
class ControlPanel:
    ...
    def toggle_cortex(self, cortex: str, visible: bool | None = None) -> None:
        ...
        """
        if cortex == "tactical":
            self.state.cortex.show_tactical = visible if visible is not None else not self.state.cortex.show_tactical
        elif cortex == "strategic":
            self.state.cortex.show_strategic = visible if visible is not None else not self.state.cortex.show_strategic
        elif cortex == "conceptual":
            self.state.cortex.show_conceptual = visible if visible is not None else not self.state.cortex.show_conceptual
    ...
    def toggle_quantum(self, enabled: bool | None = None) -> None:
        ...
        """
        self.state.quantum.enabled = enabled if enabled is not None else not self.state.quantum.enabled
        self._notify_settings_change()
