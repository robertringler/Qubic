...
class BoardPanel:
    ...
    def highlight_move(self, from_sq: int, to_sq: int, color: tuple[float, float, float, float] | None = None) -> None:
    ...
    def add_pv_arrows(self, moves: list[tuple[int, int]], base_color: tuple[float, float, float, float]) -> None:
    ...
    def set_evaluation(self, value: float, is_mate: bool = False, mate_in: int = 0, confidence: float = 1.0) -> None:
    ...
    def get_render_data(self) -> dict[str, Any]:
        ...
        for square in range(64):
            ...
            is_animating = (
                self._animation_progress < 1.0 and
                self._animation_from == square and
                self._animating_piece == piece
            )
